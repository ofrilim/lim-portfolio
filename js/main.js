...
function renderModal(projId) {
    ...
    const strHtml = `<div class="portfolio-modal modal fade" id="portfolioModal" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="container"><div class="row"><div class="col-lg-6 mx-auto"><div class="modal-body">
                    ...
                    <a href="${currProj.websiteUrl}" target="blank">visit website</a>
                    </button><button class="btn btn-primary" type="button">
                    <a href="${currProj.codeUrl}" target="blank">code</a>
                    </button><button class="btn btn-primary d-block" style="margin: 0.5rem auto" data-dismiss="modal" type="button">
